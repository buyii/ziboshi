...
export function onApplyMatch(params: Record<string, any>) {
  return alova.Post<any>('/mall/mini/product-match-log/applyMatch', {
    ...params,
  })
}
// 智能匹配记录
export function getUserMatchList(params: Record<string, any>) {
  return alova.Get<any>('/mall/mini/product-match-log/getUserMatchList', {
    params: { ...params },
  })
}
// 智能匹配记录详情
export function getUserMatchDetail(params: Record<string, any>) {
  return alova.Get<any>('/mall/mini/product-match-log/getDetail', {
    params: { ...params },
  })
}
