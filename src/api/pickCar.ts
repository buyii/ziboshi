...
export function pickCarAdd(params: Record<string, any>) {
  return alova.Post<any>('/star/mini/pick-car/add', {
    ...params,
  })
}
...
export function pickCarDel(params: Record<string, any>) {
  return alova.Get<any>(`/star/mini/pick-car/remove`, {
    params: { ...params },
  })
}
...
export function batchDelCar(params: Record<string, any>) {
  return alova.Get<any>(`/star/mini/pick-car/batchDel`, {
    params: { ...params },
  })
}
...
export function getMyCarList(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/pick-car/getMyCarList', {
    params: { ...params },
  })
}
...
export function getMyCarCount(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/pick-car/countPickCar', {
    params: { ...params },
  })
}
