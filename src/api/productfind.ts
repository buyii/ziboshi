...
export function productFindAdd(params: Record<string, any>) {
  return alova.Post<any>('/star/mini/product-find-log/apply', {
    ...params,
  })
}
...
export function getProductLogList(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/product-find-log/list', {
    params: { ...params },
  })
}
...
export function productLogUrgent(params: Record<string, any>) {
  return alova.Put<any>('/star/mini/product-find-log/urgent', {
    ...params,
  })
}
...
export function productLogDel(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/product-find-log/delete', {
    params: { ...params },
  })
}
...
export function getUnViewCount(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/product-find-log/countUnView', {
    params: { ...params },
  })
}
// 记录查看找品记录
export function viewFindProduct(params: Record<string, any>) {
  return alova.Get<any>('/star/mini/product-find-log/viewFindProduct', {
    params: { ...params },
  })
}
