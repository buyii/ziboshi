      ...
      <view class="item-left">
        ...
        <view class="item-info">
          ...
          <view class="footbox">
            <view>
              <view class="foot-num">
                <DigitBold :value="formatNumberWan(props.item.totalPayAmount || 0).value" :suffix="formatNumberWan(props.item.totalPayAmount || 0).unit" int-size="28rpx" decimal-size="22rpx" color="#222222" />
              </view>
            ...
            <view>
              <view class="foot-num">
                <DigitBold :value="formatNumberWan(props.item.orderCount || 0).value" :suffix="formatNumberWan(props.item.orderCount || 0).unit" int-size="28rpx" decimal-size="22rpx" color="#222222" />
              </view>
              <view class="label-prefix">
                全部单量
              </view>
            ...
            <view>
              <view class="foot-num">
                <DigitBold :value="formatNumberWan(props.item.kolFocCosFee || 0).value" :suffix="formatNumberWan(props.item.kolFocCosFee || 0).unit" int-size="28rpx" decimal-size="22rpx" color="#222222" />
              </view>
              <view class="label-prefix">
                全部佣金
              </view>
            ...
            <view>
              <view class="foot-num">
                <DigitBold :value="formatNumberWan(props.item.kolFocServiceFee || 0).value" :suffix="formatNumberWan(props.item.kolFocServiceFee || 0).unit" int-size="28rpx" decimal-size="22rpx" color="#222222" />
              </view>
              <view class="label-prefix">
                全部补贴
              </view>
