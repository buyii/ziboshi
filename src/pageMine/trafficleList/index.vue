...
import { trafficGetList } from '@/api/product'
...
function getDataList() {
  ...
  loading.value = true
  trafficGetList(params).then((res) => {
    if (res.code === 0) {
...
<template>
  <view class="topbox">
    <wd-navbar title="投流列表" safe-area-inset-top left-arrow :bordered="false" @click-left="handleClickLeft" />
    <view class="tab-box">
