...
const emit = defineEmits(['tabClick', 'dateTabClick'])
...
function tabClick(value: string) {
  ...
  emit('dateTabClick', dateRange.value)
  getDetail()
}
  ...
  <view class="data-wrap">
    ...
    <view class="data-content">
      ...
      <view class="totalled-wrap">
        <view class="time-tab">
          <view :class="{ 'active-tab': tabValue === 'today' }" @click="tabClick('today')">
            今天
          </view>
          <view :class="{ 'active-tab': tabValue === 'yesterday' }" @click="tabClick('yesterday')">
            昨天
          </view>
          <view :class="{ 'active-tab': tabValue === 'week' }" @click="tabClick('week')">
            本周
          </view>
          <view :class="{ 'active-tab': tabValue === 'month' }" @click="tabClick('month')">
            本月
          </view>
...
.data-wrap{
  ...
  .data-content{
    ...
    .data-chart{
      ...
      display: grid;
      grid-template-columns: repeat(4, 1fr); /* 每行三个元素 */
      border-radius: 16rpx;
      padding-top: 26rpx;
      .data-item{
        height: 106rpx;
