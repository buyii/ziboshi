...
import { getProductLogList } from '@/api/productfind'
...
<template>
  <wd-navbar title="提交成功" safe-area-inset-top fixed :bordered="false" custom-style="background: transparent;" />
  <view class="apply-warp">
    ...
    <view class="content-box">
      <image class="jilu" src="../../static/svg/zpjlTitle.svg" />
