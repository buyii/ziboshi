...
import { productLogUrgent, viewFindProduct } from '@/api/productfind'
...
const message1 = useMessage('itemmsgbox')
    ...
    <wd-swipe-action>
      <view class="store-card">
        ...
        >
          ...
          <wd-badge is-dot top="2" right="-2" :hidden="localItem.status !== '3' || localItem.userView !== 1">
